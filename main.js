...
function my_keydown(e)
{
	...
	function up()
	{
		...
		if(ball_y >=0){
			...
			console.log("Cuando se preciona la tecla de flecha hacia arriba,x= "+ball_x+",Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		 }
	}
	...
	function down()
	{
		 ...
		 if(ball_y <=500){
			ball_y=ball_y+block_image_height;
			console.log("altura de la imagen"+block_image_height);
			console.log("Cuando se preciona la tecla de flecha hacia abajo,x= "+ball_x+",Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		 }
	}
	...
	function left()
	{
		if(ball_x >0)
		{
			...
			if(ball_y <=450){
				...
				console.log("Cuando se preciona la tecla de flecha hacia izquierda,x= "+ball_x+",Y = "+ball_y);
				canvas.remove(ball_obj);
				new_image();
			 }
		}
	...
	function right()
	{
			...
			if(ball_x <=850){
				ball_x=ball_x+block_image_width;
				console.log("anchura de la imagen"+block_image_width);
				console.log("Cuando se preciona la tecla de flecha hacia derecha,x= "+ball_x+",Y = "+ball_y);
				canvas.remove(ball_obj);
				new_image();
			 }
		}
